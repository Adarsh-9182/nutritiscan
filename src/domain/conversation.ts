...
//
// The `evidence` on an assistant turn is not decoration and must
// never be generic. A chip that is always present stops meaning
// anything, and a chip that claims a source we didn't use is a
// lie in a health product.
// ============================================================
  ...
  },
  {
    ...
    turns: [
      { id: "p1", role: "user", text: "Can you explain my July blood panel?" },
      {
        ...
        evidence: [{ label: "Full blood panel · 12 Jul", source: "labs", href: "/labs" }],
